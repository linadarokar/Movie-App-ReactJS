...
const  TopRated = ()=>{
   ...
   const genreforURL = useGenres(selectedGenres)
    const GetDataTrending = async ()=>{
        ...
        const {data} = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=${API_KEY}&page=${pageno}&with_genres=&language=en-US&with_genres=${genreforURL}`)
            ...
            <Container>
                <Row>
                    <Col className='col-12'>
                        <section>
                            <h1 className='txtCenter'>Top Rated Movies</h1>
                        </section>
                    </Col>
                </Row>
                <Row>
